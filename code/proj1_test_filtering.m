...
identity_image2  = imfilter(test_image, identity_filter);

figure(2); imshow(identity_image);
imwrite(identity_image, 'identity_image.jpg', 'quality', 95);
imwrite(identity_image2, 'identity_image_im.jpg', 'quality', 95);
...
id_blur_image = my_imfilter(test_image, blur_filter);

figure(3); imshow(blur_image);
imwrite(blur_image, 'blur_image.jpg', 'quality', 95);
imwrite(id_blur_image, 'blur_image_im.jpg', 'quality', 95);
...
large_blur_image2 = imfilter(test_image, large_1d_blur_filter);
large_blur_image2 = imfilter(large_blur_image, large_1d_blur_filter'); %notice the ' operator which transposes the filter

figure(4); imshow(large_blur_image);
imwrite(large_blur_image, 'large_blur_image.jpg', 'quality', 95);
imwrite(large_blur_image2, 'large_blur_image_im.jpg', 'quality', 95);
...
sobel_image2 = imfilter(test_image, sobel_filter);

%0.5 added because the output image is centered around zero otherwise and mostly black
figure(5); imshow(sobel_image + 0.5);
imwrite(sobel_image + 0.5, 'sobel_image.jpg', 'quality', 95);
imwrite(sobel_image2 + 0.5, 'sobel_image_im.jpg', 'quality', 95);
