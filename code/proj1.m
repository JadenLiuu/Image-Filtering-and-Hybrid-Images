...
blur_image = my_imfilter(image2,filter);
high_frequencies = image2 - blur_image;
...
figure(3); imshow(vis);
imwrite(low_frequencies, '../results/low_frequencies.jpg', 'quality', 95);
imwrite(high_frequencies + 0.5, '../results/high_frequencies.jpg', 'quality', 95);
